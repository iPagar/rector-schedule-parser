      ...
      (_c =
        (_b =
          (_a = text
            .slice(
              beginIndex,
              date === null || date === void 0 ? void 0 : date.index
            )
            .match(/\.(?<group>(.*))\./)) === null || _a === void 0
            ? void 0
            : _a.groups) === null || _b === void 0
          ? void 0
          : _b.group.trim()) !== null && _c !== void 0
        ? _c
        : "";
    return Object.assign(
      Object.assign(
        Object.assign(
          { stgroup, subject: subject[0], audience: audience },
          parseDate(date[1])
        ),
        parseTime(x)
      ),
...
function parseDate(text) {
  ...
  const formattedPeriods = periods.map((period) => {
    var _a, _b, _c;
    const start_date =
      (_a = period.groups) === null || _a === void 0 ? void 0 : _a.start_date;
    if (start_date === undefined)
      throw new Error("Не удалось распарсить дату" + period.toString());
    const end_date =
      (_b = period.groups) === null || _b === void 0 ? void 0 : _b.end_date;
    if (end_date === undefined)
      throw new Error("Не удалось распарсить дату" + period.toString());
    const repeat =
      (_c = period.groups) === null || _c === void 0 ? void 0 : _c.repeat;
    if (repeat === undefined)
      throw new Error("Не удалось распарсить дату" + period.toString());
    if (!isRepeat(repeat))
      throw new Error("Не удалось распарсить дату" + period.toString());
